...
<h1>MVC Board [${findString} 검색결과]</h1>
   <p>
...
<table class="table table-striped table-condensed table-hover">
   ...
   <tr>
      ...
      <%--
       ...
       <ul class="pagination">
          	<li><a href="board-find.do?cpage=${cpage-1}">Prev</a></li>
          ...
          <c:forEach var = "i" begin = '1' end = "${pageCount}" step = '1'>
             ...
             <c:if test='${i ne cpage}'>
		 	 	<li><a href="board-find.do?cpage=${i}#bbs">${i}</a></li>
		 	 </c:if>
		  </c:forEach>
		  
		  	<li><a href="board-find.do?cpage=${cpage+1}">Next</a></li>
	   </ul> 
